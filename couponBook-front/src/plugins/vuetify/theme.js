...
export const staticPrimaryColor = '#2563EB' // Azul principal de Qurable
export const staticPrimaryDarkenColor = '#1D4ED8' // Azul más oscuro
...
export const themes = {
  light: {
    ...
    colors: {
      ...
      secondary: '#10B981', // Verde de Qurable
      ...
      'on-info': '#fff',
      warning: '#F59E0B', // Amarillo/naranja para warning
    ...
    variables: {
      'code-color': '#2563EB', // Azul de Qurable para código
      'overlay-scrim-background': '#2E263D',
      'tooltip-background': '#1A0E33',
      'overlay-scrim-opacity': 0.5,
      'hover-opacity': 0.04,
  ...
  dark: {
    ...
    variables: {
      'code-color': '#3B82F6', // Azul más claro para tema oscuro
      'overlay-scrim-background': '#312D4B',
      'tooltip-background': '#F7F4FF',
      'overlay-scrim-opacity': 0.5,
      'hover-opacity': 0.04,
